...
CATEGORIES = {
    ...
    "career": {
        ...
        "keywords": [
            ...
            "burnout", "productivity", "mentoring",
            "conference", "tutorial", "learning path",
    ...
    "mobile": {
        ...
        "keywords": [
            ...
            "flutter", "dart", "mobile app", "mobile development",
            "swiftui", "jetpack compose", "xcode", "android studio",
            "app store", "google play", "expo", "capacitor",
            "ionic", "maui", "xamarin", "watchos", "wearable",
            "mobile ui", "responsive mobile", "pwa", "cordova",
        ],
    },
    "data": {
        "label_en": "Data & Databases",
        "label_pt": "Dados & Bancos de Dados",
        "keywords": [
            "postgresql", "postgres", "mysql", "mongodb", "redis",
            "sqlite", "database", "sql", "nosql", "data engineering",
            "data pipeline", "etl", "data warehouse", "bigquery",
            "snowflake", "clickhouse", "elasticsearch", "opensearch",
            "apache kafka", "kafka", "apache spark", "spark",
            "data lake", "data mesh", "dbt", "airflow",
            "analytics", "olap", "timeseries", "graph database",
            "neo4j", "cassandra", "dynamodb", "cockroachdb",
            "supabase", "planetscale", "neon", "turso",
        ],
    },
    "opensource": {
        "label_en": "Open Source",
        "label_pt": "Open Source",
        "keywords": [
            "open source", "open-source", "oss", "foss",
            "contributor", "maintainer", "github sponsor",
            "pull request", "merge request", "issue tracker",
            "license", "mit license", "apache license", "gpl",
            "hacktoberfest", "gsoc", "linux foundation",
            "cncf", "apache foundation", "mozilla",
            "free software", "community driven", "public repo",
            "forking", "contribution guide",
        ],
    },
    "tools": {
        "label_en": "Tools & Productivity",
        "label_pt": "Ferramentas & Produtividade",
        "keywords": [
            "vscode", "vs code", "neovim", "vim", "ide", "editor",
            "terminal", "cli", "command line", "shell", "zsh", "bash",
            "git", "github", "gitlab", "bitbucket",
            "tmux", "dotfiles", "dev tools", "developer tools",
            "linter", "formatter", "prettier", "eslint", "ruff",
            "debugger", "profiler", "benchmark", "testing tool",
            "automation", "workflow", "makefile", "task runner",
            "package manager", "npm", "pip", "cargo", "brew",
            "documentation", "api docs", "swagger", "postman",
        ],
    },
}
